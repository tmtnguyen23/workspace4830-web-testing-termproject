...
public class ManageAccount1 {
	  ...
	  public void testLoginpage() throws Exception {
		    ...
		    driver.findElement(By.name("fname")).sendKeys("Jim");
		    driver.findElement(By.xpath("//input[@value='Submit']")).click();

		    String expected = "First name: Jim";
		    String result = driver.findElement(By.id("first-name")).getText();
